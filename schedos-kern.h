...
typedef struct process {
	...
	int p_priority;			// Exercise 4A priority field
	int p_share;			// Exercise 4B share field
	int p_currentRun;       // Exercise 4B current run amount
	int p_tickets;			// Exercise 7 Lottery Scheduling ticket amt
} process_t;
